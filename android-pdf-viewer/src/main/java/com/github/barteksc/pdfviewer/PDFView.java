...
public class PDFView extends RelativeLayout {
    ...
    /**
     * True if should scroll through pages swipeVertical instead of horizontally
     */
    ...
    public void jumpTo(int page, boolean withAnimation) {
        ...
        Log.i(TAG, "jumpTo " + page + " , withAnimation: " + withAnimation + " ,swipeVertical: " + swipeVertical);
    ...
    public void setPositionOffset(float progress, boolean moveHandle) {
        Log.i(TAG, "setPositionOffset " + progress);
        if (swipeVertical) {
    ...
    public boolean canScrollHorizontally(int direction) {
        Log.i(TAG, "canScrollHorizontally " + direction);
        if (pdfFile == null) {
            return true;
        }
    ...
    public boolean canScrollVertically(int direction) {
        Log.i(TAG, "canScrollVertically " + direction);
        if (pdfFile == null) {
            return true;
        }
...
//        Log.i(TAG, " Moves the canvas before drawing any element, x: "
//                + currentXOffset + " ,y:" + currentYOffset
...
//        Log.i(TAG, "getPageRelativeBounds: " + pageRelativeBounds.toString());
...
//        Log.i(TAG, "getPageSize: " + size + " pageIndex: " + part.getPage()
//                + " swipeVertical: " + swipeVertical + " zoom: " + zoom);
        if (swipeVertical) {
...
//        Log.i(TAG, "canvas.translate localTranslationX: " + localTranslationX
//                + " localTranslationY: " + localTranslationY);
        canvas.translate(localTranslationX, localTranslationY);

        Rect srcRect = new Rect(0, 0, renderedBitmap.getWidth(),
                renderedBitmap.getHeight());

//        Log.i(TAG, "srcRect: " + srcRect.toString());
...
//        Log.i(TAG, "dstRect: " + dstRect.toString());
        ...
        if (translationX + dstRect.left >= getWidth() || translationX + dstRect.right <= 0 ||
            ...
            canvas.translate(-localTranslationX, -localTranslationY);
//            Log.i(TAG, "bitmap is not in the screen.");
            return;
        }
    ...
    public void moveTo(float offsetX, float offsetY) {
        Log.i(TAG, "moveTo X" + offsetX + " Y " + offsetY);
    ...
    void loadPageByOffset() {
        ...
        Log.i(TAG, "loadPageByOffset screenCenter: " + screenCenter + " page: " + page);
